...
.method public static varargs getInstance(Lcom/ibm/icu/util/ULocale;[Lcom/ibm/icu/text/DisplayContext;)Lcom/ibm/icu/text/LocaleDisplayNames;
    ...
    .line 111
    sget-object v0, Lcom/ibm/icu/text/LocaleDisplayNames;->FACTORY_DISPLAYCONTEXT:Ljava/lang/reflect/Method;
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/ibm/icu/text/LocaleDisplayNames$LastResortLocaleDisplayNames;-><init>(Lcom/ibm/icu/util/ULocale;[Lcom/ibm/icu/text/DisplayContext;Lcom/ibm/icu/text/LocaleDisplayNames$1;)V

    :cond_1
    return-object v0
.end method

.method public static getInstance(Ljava/util/Locale;)Lcom/ibm/icu/text/LocaleDisplayNames;
    .locals 0
    ...
    invoke-static {p0}, Lcom/ibm/icu/text/LocaleDisplayNames;->getInstance(Lcom/ibm/icu/util/ULocale;)Lcom/ibm/icu/text/LocaleDisplayNames;
...
.method public static varargs getInstance(Ljava/util/Locale;[Lcom/ibm/icu/text/DisplayContext;)Lcom/ibm/icu/text/LocaleDisplayNames;
    .locals 0
    ...
    invoke-static {p0, p1}, Lcom/ibm/icu/text/LocaleDisplayNames;->getInstance(Lcom/ibm/icu/util/ULocale;[Lcom/ibm/icu/text/DisplayContext;)Lcom/ibm/icu/text/LocaleDisplayNames;
...
# virtual methods
.method public abstract getContext(Lcom/ibm/icu/text/DisplayContext$Type;)Lcom/ibm/icu/text/DisplayContext;
.end method
...
.method public getUiList(Ljava/util/Set;ZLjava/util/Comparator;)Ljava/util/List;
    ...
    .line 286
    invoke-static {p3, p2}, Lcom/ibm/icu/text/LocaleDisplayNames$UiListItem;->getComparator(Ljava/util/Comparator;Z)Ljava/util/Comparator;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lcom/ibm/icu/text/LocaleDisplayNames;->getUiListCompareWholeItems(Ljava/util/Set;Ljava/util/Comparator;)Ljava/util/List;
...
.method public scriptDisplayNameInContext(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 228
    invoke-virtual {p0, p1}, Lcom/ibm/icu/text/LocaleDisplayNames;->scriptDisplayName(Ljava/lang/String;)Ljava/lang/String;
