...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    .line 940
    new-instance v1, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    const-string v3, "ISLAMIC_CIVIL"

    const/4 v4, 0x1

    const-string v5, "islamic-civil"

    invoke-direct {v1, v3, v4, v5}, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;->ISLAMIC_CIVIL:Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    .line 945
    new-instance v3, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    const-string v5, "ISLAMIC_UMALQURA"

    const/4 v6, 0x2

    const-string v7, "islamic-umalqura"

    invoke-direct {v3, v5, v6, v7}, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v3, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;->ISLAMIC_UMALQURA:Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    .line 951
    new-instance v5, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    const-string v7, "ISLAMIC_TBLA"

    const/4 v8, 0x3

    const-string v9, "islamic-tbla"

    invoke-direct {v5, v7, v8, v9}, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v5, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;->ISLAMIC_TBLA:Lcom/ibm/icu/util/IslamicCalendar$CalculationType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/ibm/icu/util/IslamicCalendar$CalculationType;
    ...
    .line 929
    sput-object v7, Lcom/ibm/icu/util/IslamicCalendar$CalculationType;->$VALUES:[Lcom/ibm/icu/util/IslamicCalendar$CalculationType;
