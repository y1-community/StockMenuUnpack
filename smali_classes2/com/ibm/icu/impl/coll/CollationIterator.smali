...
.method private final nextCE32FromContraction(Lcom/ibm/icu/impl/coll/CollationData;ILjava/lang/CharSequence;III)I
    ...
    .line 729
    :cond_1
    iget-object p6, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->skipped:Lcom/ibm/icu/impl/coll/CollationIterator$SkippedState;

    if-eqz p6, :cond_2

    invoke-virtual {p6}, Lcom/ibm/icu/impl/coll/CollationIterator$SkippedState;->isEmpty()Z
    ...
    invoke-virtual {p6, v2}, Lcom/ibm/icu/impl/coll/CollationIterator$SkippedState;->saveTrieState(Lcom/ibm/icu/util/CharsTrie;)V
    ...
    .line 766
    invoke-virtual {v2, p6}, Lcom/ibm/icu/util/CharsTrie;->nextForCodePoint(I)Lcom/ibm/icu/util/BytesTrie$Result;
...
.method private final previousCEUnsafe(ILcom/ibm/icu/impl/coll/UVector32;)J
    .locals 5
    ...
    .line 916
    iget-object v2, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->data:Lcom/ibm/icu/impl/coll/CollationData;

    iget-boolean v3, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->isNumeric:Z

    invoke-virtual {v2, v1, v3}, Lcom/ibm/icu/impl/coll/CollationData;->isUnsafeBackward(IZ)Z
    ...
    .line 928
    invoke-virtual {p0}, Lcom/ibm/icu/impl/coll/CollationIterator;->getOffset()I

    move-result v2

    .line 929
    :cond_2
    iget v3, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->numCpFwd:I
    ...
    .line 932
    iput v3, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->numCpFwd:I
    ...
    iget v3, v3, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I

    iput v3, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->cesIndex:I

    .line 942
    invoke-virtual {p2, v2}, Lcom/ibm/icu/impl/coll/UVector32;->addElement(I)V
    ...
    .line 946
    :goto_0
    invoke-virtual {p2}, Lcom/ibm/icu/impl/coll/UVector32;->size()I

    move-result v3

    iget-object v4, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->ceBuffer:Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;

    iget v4, v4, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I
    ...
    .line 959
    iget-object p2, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->ceBuffer:Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;

    iget v0, p2, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I

    sub-int/2addr v0, p1

    iput v0, p2, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I

    invoke-virtual {p2, v0}, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->get(I)J
...
.method public final nextCE()J
    ...
    invoke-virtual {v4, v7, v1, v2}, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->set(IJ)J
...
.method public final previousCE(Lcom/ibm/icu/impl/coll/UVector32;)J
    .locals 7
    ...
    iget v0, p1, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I

    sub-int/2addr v0, v1

    iput v0, p1, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->length:I

    invoke-virtual {p1, v0}, Lcom/ibm/icu/impl/coll/CollationIterator$CEBuffer;->get(I)J
    ...
    .line 311
    :cond_0
    invoke-virtual {p1}, Lcom/ibm/icu/impl/coll/UVector32;->removeAllElements()V
    ...
    iget-boolean v4, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->isNumeric:Z

    invoke-virtual {v3, v2, v4}, Lcom/ibm/icu/impl/coll/CollationData;->isUnsafeBackward(IZ)Z
    ...
    .line 316
    invoke-direct {p0, v2, p1}, Lcom/ibm/icu/impl/coll/CollationIterator;->previousCEUnsafe(ILcom/ibm/icu/impl/coll/UVector32;)J
    ...
    invoke-virtual {v3, v2}, Lcom/ibm/icu/impl/coll/CollationData;->getCE32(I)I
    ...
    .line 326
    :cond_3
    iget-object v4, p0, Lcom/ibm/icu/impl/coll/CollationIterator;->data:Lcom/ibm/icu/impl/coll/CollationData;

    .line 328
    :goto_0
    invoke-static {v3}, Lcom/ibm/icu/impl/coll/Collation;->isSimpleOrLongCE32(I)Z
    ...
    .line 329
    invoke-static {v3}, Lcom/ibm/icu/impl/coll/Collation;->ceFromCE32(I)J
    ...
    .line 331
    invoke-virtual {p0, v4, v2, v3, v5}, Lcom/ibm/icu/impl/coll/CollationIterator;->appendCEsFromCE32(Lcom/ibm/icu/impl/coll/CollationData;IIZ)V
    ...
    invoke-virtual {p1, v2}, Lcom/ibm/icu/impl/coll/UVector32;->addElement(I)V

    .line 336
    :goto_1
    invoke-virtual {p1}, Lcom/ibm/icu/impl/coll/UVector32;->size()I
    ...
    .line 337
    invoke-virtual {p1, v0}, Lcom/ibm/icu/impl/coll/UVector32;->addElement(I)V
